...
import photo from "../../assets/journey2.jpg";
import { FaCheckCircle } from "react-icons/fa";
import { IoIosStats } from "react-icons/io";
import { RiTimeLine } from "react-icons/ri";
import { BsAward } from "react-icons/bs";

export default function GeniusKid() {
  const stars = [];
  ...
  return (
    <div className="bg-indigo-100 px-20 py-14 font-poppins">
      <h1 className="text-3xl font-semibold">Genius Kids Bootcamp</h1>
      <div className="flex items-center gap-8 text-zinc-600 py-7">
        ...
        <h1>Category: Skill Development & Confidence Building</h1>
        ...
        <div className="w-3/5 ">
          ...
          <div>
            ...
            <p className="text-justify text-[17px] text-zinc-700">
              Give your child a head start with Genius Kids Bootcamp! This
              dynamic program is designed to spark curiosity, build confidence,
              and develop key skills through engaging challenges and interactive
              learning experiences. Whether exploring science, technology, or
              creative problem-solving, this bootcamp empowers young learners to
              think big and embrace new ideas with enthusiasm.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            ...
            {[
              "Build confidence through engaging group challenges",
              "Develop problem-solving skills with interactive exercises",
              "Participate in fun brain-boosting activities",
              "Improve teamwork and leadership through collaborative tasks",
              "Strengthen learning with hands-on projects and skill-building exercises",
            ].map((item, index) => (
        ...
        <div className="ml-10 w-2/5 flex flex-col gap-5">
          <div className="pl-8 py-7 border-[1px] border-zinc-500 rounded-md">
            ...
            <div className="flex flex-col gap-2 mt-3">
              {[
                "Confidence-building exercises and interactive challenges",
                "Hands-on activities for critical thinking and problem-solving",
                "Printable worksheets and skill-enhancing tasks",
                "Access to engaging video lessons",
          ...
          <div className="text-[18px] text-zinc-600 pl-8 py-7 border-[1px] border-zinc-500 rounded-md flex flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1>3 hour 45 minutes Duration</h1>
            </div>
            <div className="flex items-center gap-2">
              <div className="text-indigo-500 text-xl">
                <BsAward />
