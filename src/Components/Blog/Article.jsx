...
export default function Article() {
  return (
    <div className="xl:p-20 py-10 px-5 font-poppins container mx-auto">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex lg:flex-row flex-col gap-3 lg:gap-0 lg:items-center items-start justify-between">
