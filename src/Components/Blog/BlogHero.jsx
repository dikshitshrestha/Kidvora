    ...
    <div className="bg-indigo-100 font-poppins flex items-center">
      <div className="w-1/2 pl-20">
        ...
        <div className="text-[18px] flex gap-2">
          <NavLink
            to="/courses"
            className="border-[1px] px-11 py-3 rounded-full bg-red-500 hover:bg-red-800 ease-in-out duration-300 text-white"
          >
            Explore Courses
          </NavLink>
          <NavLink
            to="/login"
            className="border-black border-[1px] px-11 py-3 rounded-full hover:bg-indigo-400 ease-in-out duration-300 text-black hover:border-indigo-400 hover:text-white"
          >
            Sign Up Now
          </NavLink>
        </div>
