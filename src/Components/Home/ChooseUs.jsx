...
export default function ChooseUs() {
  ...
  return (
    <div className="bg-red-100 font-poppins py-20">
      ...
      <div className="text-center flex flex-col gap-2 py-6">
        ...
        <h1 className="text-[18px] text-zinc-700">
          Unlocking Every Child’s Potential with Engaging Learning Experiences
        </h1>
      </div>

      <div className="flex items-center w-full gap-6 px-20 py-10">
        ...
        <div className="row-span-2 w-1/3 h-[520px] rounded-2xl overflow-hidden">
      ...
      <a href="#" className="flex justify-center items-center">
        <div className="flex justify-center items-center gap-1.5 bg-red-300 px- text-xl px-5 py-2 rounded-full text-white ease-in-out duration-300 underline hover:bg-indigo-400">
          <h1>Explore More</h1>
          <IoArrowForwardSharp />
        </div>
      </a>
